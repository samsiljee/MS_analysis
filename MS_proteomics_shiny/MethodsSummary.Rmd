...
`r if (params$input$quant_method == "LFQ" & params$input$input.summaryMethod == "linear") paste("Account for heterogeneous variation among intensities from different features:", params$input$equalFeatureVar)`

`r if (params$input$quant_method == "LFQ" & params$input$input.summaryMethod == "TMP") paste("Impute censored values by Accelated failure model:", params$input$MBimpute)`

`r if (params$input$quant_method == "LFQ" & params$input$input.summaryMethod == "TMP") paste("Remove runs with >50% missing values:", params$input$remove50missing)`
