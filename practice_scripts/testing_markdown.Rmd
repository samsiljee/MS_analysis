...
run_annot <- vroom(paste0(input_dir, "TMT/run_annotations.txt"))
channel_annot <- vroom(paste0(input_dir, "TMT/channel_annotations.txt"))
...
TMT_compared <- groupComparisonTMT(TMT_processed, save_fitted_models = TRUE)
```
